...
\paragraph{Latency}
Stage service is deterministic, so a tier behaves as an M/D/1 queue and the
Pollaczek--Khinchine formula~\cite{kleinrock1975queueing} gives the waiting time. With
